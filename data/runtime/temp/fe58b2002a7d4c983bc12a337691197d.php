<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"themes/erp/admin\index\editrole.html";i:1568530954;s:60:"E:\web\www915\public\themes\erp\admin\public\layui_form.html";i:1568524108;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
     ...
     <div class="main">
            <form class="layui-form" action="" style="height: 500px;"> 
             <input type="hidden" name="role[id]" value="<?php echo $data['id']; ?>"> 
                <div class="layui-form-item">
                <label class="layui-form-label">角色<?php echo $data['rules']; ?>名称</label>
                  <div class="layui-input-inline">
                    <input type="text" name="role[title]" value="<?php echo $data['title']; ?>" required lay-verify="required" placeholder="请输入角色名称" autocomplete="off" class="layui-input">
                 </div>
                </div>
                <div class="layui-form-item">
        ...
        <div class="layui-input-block">
         ...
         <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="radio" name="role[status]" value="1" title="正常"
                <?php if($data['status'] == 1): ?>checked <?php endif; ?>>
            <input type="radio" name="role[status]" value="0" title="禁用" <?php if($data['status'] == 0): ?>checked <?php endif; ?>>
          </div>
        </div>
        <div class="layui-form-item layui-form-text">
          <label class="layui-form-label">备注</label>
          <div class="layui-input-block" style="width:260px;">
            <textarea name="role[remark]" placeholder="请输入备注" class="layui-textarea"><?php echo $data['remark']; ?></textarea>
          </div>
        </div>
...
<script type="text/javascript" src="/themes/erp/public/assets/lib/layui-v2.5.5/layui/layui.js"></script>
    ...
    layui.config({
        ...
        kform.set({
            url:'<?php echo url('index/editrole'); ?>',
          success:function(r){
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        tree.setChecked('demoId1',[<?php echo $data['rules']; ?>]); //勾选指定节点
        }
    });
