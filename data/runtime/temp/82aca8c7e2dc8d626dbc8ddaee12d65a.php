<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"themes/erp/admin\notice\editNotice.html";i:1547519484;s:60:"E:\web\www915\public\themes\erp\admin\public\layui_form.html";i:1562115663;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
    ...
    <div class="main">
            <form class="layui-form" action="">
                <input type="hidden" name="id" value="<?php echo $notice_find['id']; ?>">
                <div class="layui-form-item">
                    <label class="layui-form-label">标题</label>
                    <div class="layui-input-inline">
                        <input type="text" name="title" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" value="<?php echo $notice_find['title']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                  <label class="layui-form-label">内容</label>
                  <div class="layui-input-block">
                    <textarea name="content" placeholder="请输入内容" class="layui-textarea"><?php echo $notice_find['content']; ?></textarea>
                  </div>
                </div>
